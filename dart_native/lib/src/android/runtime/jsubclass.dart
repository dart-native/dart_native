...
class JSubclass<T> extends JObject {
  ...
  JSubclass(this.raw, InitSubclass init, String clsName) : super(clsName, init(raw, clsName));
  JSubclass.fromPointer(Pointer<Void> ptr, String clsName) : super(clsName, ptr);
