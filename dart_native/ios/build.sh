...
xcodebuild -create-xcframework -framework build/macOS/UninstalledProducts/macosx/DartNative_macOS.framework -framework build/iOS/UninstalledProducts/iphoneos/DartNative.framework -framework build/simulator/UninstalledProducts/iphonesimulator/DartNative.framework -output build/DartNative.xcframework
