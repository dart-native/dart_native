#!/bin/sh
rm -rf ./build
xcodebuild archive -project DartNative.xcodeproj -scheme "DartNative" -sdk iphoneos15.0 OBJROOT=build/iOS
xcodebuild archive -project DartNative.xcodeproj -scheme "DartNative" -sdk iphonesimulator15.0 OBJROOT=build/simulator
