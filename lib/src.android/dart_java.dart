...
class DartJava {
  ...
  static Future<double> get platformVersionDouble async {
    final double version = await _channel.invokeMethod('getPlatformVersionDouble');
    return version;
  }

  static Future<ffi.Int8> get platformVersionByte async {
    final ffi.Int8 version = await _channel.invokeMethod('getPlatformVersionByte');
    return version;
  }

  static Future<String> get platformVersionString async {
    final String version = await _channel.invokeMethod('getPlatformVersionString');
    return version;
  }
}
